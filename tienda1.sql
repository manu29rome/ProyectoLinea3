...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-06-2021 a las 02:15:57
...
--
CREATE DATABASE IF NOT EXISTS `tienda1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tienda1`;
...
INSERT INTO `carrito` (`idcarrito`, `idpro`, `cantidad`, `idus`, `status`) VALUES
(62, 2, 1, 1, 1),
(63, 1, 1, 1, 1),
(64, 1, 1, 1, 1),
(65, 1, 1, 1, 1),
...
INSERT INTO `categorias` (`idca`, `categoria`, `descripcionca`, `status`, `imagen`, `idus`) VALUES
(1, 'Bolsas Basuras', 'Empacara residuos', 1, 'Assets/Images/Categorias/', 1),
(2, 'Bolsas Vivero', 'Empacar plantas', 1, 'Assets/Images/Categorias/viveros.jpg', 1),
(7, 'Semilleros', 'empacar semillas', 1, 'Assets/Images/Categorias/', 19);
...
INSERT INTO `mensaje` (`id`, `email`, `msg`, `idus`, `fecha`, `status`) VALUES
(1, 'manuel29romero1996@gmail.com', 'klmk', 0, '29/01/21', 0),
(2, 'manuel29romero1996@gmail.com', 'asddfszsdf', 1, '29/01/21', 0);
...
INSERT INTO `permisosrol` (`idper`, `opcionper`, `ver`, `editar`, `eliminar`, `anadir`, `rolid`) VALUES
(60, 'Inicio', 1, 0, 0, 0, 1),
(61, 'rol', 1, 1, 1, 1, 1),
(62, 'usuario', 1, 1, 0, 0, 1),
(63, 'productos', 1, 0, 0, 0, 1),
(64, 'categorias', 1, 0, 1, 0, 1),
(65, 'pedidos', 1, 0, 0, 0, 1),
(66, 'subcategorias', 1, 0, 0, 0, 1),
(67, 'clientes', 1, 0, 0, 0, 1),
(68, 'Inicio', 1, 1, 1, 1, 2),
(69, 'rol', 1, 1, 1, 1, 2),
(70, 'usuario', 1, 1, 1, 1, 2),
(71, 'productos', 1, 1, 1, 1, 2),
(72, 'categorias', 1, 1, 1, 1, 2),
(73, 'pedidos', 1, 1, 1, 1, 2),
(74, 'subcategorias', 1, 1, 1, 1, 2),
(75, 'clientes', 1, 1, 1, 1, 2),
(163, 'Inicio', 0, 0, 0, 0, 23),
(164, 'rol', 0, 0, 0, 0, 23),
(165, 'usuario', 0, 0, 0, 0, 23),
(166, 'productos', 0, 0, 0, 0, 23),
(167, 'categorias', 0, 0, 0, 0, 23),
(168, 'pedidos', 0, 0, 0, 0, 23),
(169, 'subcategorias', 0, 0, 0, 0, 23),
(170, 'clientes', 0, 0, 0, 0, 23);
...
CREATE TABLE `persona` (
  `idus` bigint(20) NOT NULL,
  `nombreus` varchar(40) NOT NULL,
  `apellidous` varchar(40) NOT NULL,
  `email` varchar(60) NOT NULL,
  `telefono` varchar(10) NOT NULL,
  `rolid` bigint(20) NOT NULL,
  `Password` varchar(50) NOT NULL,
  `status` int(1) NOT NULL,
  `identificacionus` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `persona` (`idus`, `nombreus`, `apellidous`, `email`, `telefono`, `rolid`, `Password`, `status`, `identificacionus`) VALUES
(1, 'Manuel', 'Romero', 'manuel29romero1996@gmail.com', '3164777658', 2, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 1069756504),
(19, 'Ciro', 'Romero', 'cialrope722@gmail.com', '3202084890', 2, 'N2k3cGVld0tOSkh3SGpBcDZUNzhidz09', 1, 11388687),
(20, 'gregorio', 'romero', 'papa@gmail.com', '2476152', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 8875363),
(21, 'pishuu', 'pishuuuu', 'pishu@gmail.com', '313114323', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 12345678),
(22, 'andres', 'romero', 'aaromeroh59@gmail.com', '3024045410', 1, 'MVRlN0RZNURNOVhQVFR0WC9nYWRJUT09', 1, 1069751885),
(23, 'nicolas', 'rondon', 'nicoleiro99@hotmail.com', '3005787371', 1, 'ZW8zcy9CdCsxd1dzOXZNc0svOE9zUT09', 1, 1069768854),
(24, 'manuel', 'romero', 'manuel29romero199@gmail.com', '3164777658', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 1069756500),
(25, 'manuel', 'romero', 'manul29romero1996@gmail.com', '3164777658', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 1069756522),
(26, 'manuel', 'romero', 'manuel29rmero1996@gmail.com', '3164777658', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 1069756506),
(27, 'manuel', 'romero', 'muel29romero1996@gmail.com', '3164777658', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 1069756501),
(28, 'manuel', 'romero', 'uel29romero1996@gmail.com', '3164777658', 1, 'SVRCK3RZdmVBT0h2aFFuc3M1aXV0UT09', 1, 1069756567);
...
INSERT INTO `productos` (`idpro`, `codigo`, `producto`, `descripcion`, `stock`, `precio`, `status`, `idca`) VALUES
(2, '10002', '7x8', '<p>sirve para empcar dos veces</p>', 2991, 2100, 1, 14),
(6, '10009', '4x4', '<p>nadlfknsd</p>', 9, 13500, 1, 14),
(25, '13425', '7x7', '<h1>Empacar<strong><em> cosas</em></strong></h1>', 87, 18500, 1, 12),
(26, '12347', 'pishuu', '<p>Te Amo</p>', 78, 100000, 1, 16),
(27, '12343', 'Agucate', '<p>es muy ricoo</p>', 32, 12355, 1, 18);
...
INSERT INTO `subcategorias` (`idsubca`, `subcategoria`, `descripcion`, `status`, `imagen`, `idca`) VALUES
(12, 'B_SEMILLERO-FUELLE', 'fruta verde', 1, 'Assets/Images/subCategorias/viveros.jpg', 1),
(14, 'B_ BASURA-KILO', 'fruta de color naranja', 1, 'Assets/Images/subCategorias/', 7),
(16, 'B_BASURA-PAQUETE', 'Paquete', 1, 'Assets/Images/subCategorias/', 1),
(17, 'B_SEMILLERO', 'NORMAL', 1, 'Assets/Images/subCategorias/', 1),
(18, 'B_VIVERO-ESTANDAR', 'VIVEROS', 1, 'Assets/Images/subCategorias/', 2),
(19, 'B_VIVERO-ESPECIAL', 'ESPECIAL', 1, 'Assets/Images/subCategorias/', 2);
...
--
ALTER TABLE `carrito`
  MODIFY `idcarrito` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT de la tabla `categorias`
--
ALTER TABLE `categorias`
  MODIFY `idca` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `imagenes`
  MODIFY `idima` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `permisosrol`
  MODIFY `idper` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT de la tabla `persona`
--
ALTER TABLE `persona`
  MODIFY `idus` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `productos`
--
ALTER TABLE `productos`
  MODIFY `idpro` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `subcategorias`
  MODIFY `idsubca` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
